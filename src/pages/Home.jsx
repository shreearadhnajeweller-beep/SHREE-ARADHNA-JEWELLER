...
<section id="contact" className="contact-section">
      ...
      <section className="instagram-feed-section" style={{
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          <a 
            href="https://www.instagram.com/aradhanagoldhouse?igsi=Nmx2ZDE5cGVlN2ts" 
            target="_blank" 
            rel="noreferrer" 
          ...
          {instaFeedUrl && !instaFeedUrl.includes('behold.so') && !instaFeedUrl.endsWith('.json') ? (
            <div style={{ width: '100%', overflow: 'hidden', borderRadius: '16px', border: '1px solid rgba(114, 27, 41, 0.15)', marginBottom: '32px', boxShadow: '0 8px 32px rgba(114, 27, 41, 0.05)' }}>
              <iframe 
                src={instaFeedUrl} 
            ...
            <div style={{ 
              ...
              marginBottom: '32px'
                ...
                {([ { url: '/assets/ZIPRINGS/new_ring_3.jpeg', link: 'https://www.instagram.com/aradhanagoldhouse?igsi=Nmx2ZDE5cGVlN2ts', title: 'Gents Ring Classic' },
                { url: '/assets/silver_heart_bangles.jpg', link: 'https://www.instagram.com/aradhanagoldhouse?igsi=Nmx2ZDE5cGVlN2ts', title: 'Silver Heart Bangles' },
                { url: '/assets/gents_collection_img.jpg', link: 'https://www.instagram.com/aradhanagoldhouse?igsi=Nmx2ZDE5cGVlN2ts', title: 'Gents Gold Collection' },
                { url: '/assets/ladies_collection_img.jpg', link: 'https://www.instagram.com/aradhanagoldhouse?igsi=Nmx2ZDE5cGVlN2ts', title: 'Ladies Gold Bangle' },
                { url: '/assets/ZIPWEDDING_NEW/wc1.jpeg', link: 'https://www.instagram.com/aradhanagoldhouse?igsi=Nmx2ZDE5cGVlN2ts', title: 'Bridal Wedding Set' },
                { url: '/assets/ZIPWEDDING_NEW/wc2.jpeg', link: 'https://www.instagram.com/aradhanagoldhouse?igsi=Nmx2ZDE5cGVlN2ts', title: 'Luxury Gold Choker' },
                { url: '/assets/ZIPWEDDING_NEW/wc3.jpeg', link: 'https://www.instagram.com/aradhanagoldhouse?igsi=Nmx2ZDE5cGVlN2ts', title: 'Traditional Gold Bangle' },
                { url: '/assets/hero_2.jpg', link: 'https://www.instagram.com/aradhanagoldhouse?igsi=Nmx2ZDE5cGVlN2ts', title: 'Gold Rings Set' }
              ]).map((post, idx) => (
                <a 
                  key={idx} 
                  href={post.link} 
